...
async function serveStatic(request, response, pathname) {
  ...
  try {
    ...
    response.writeHead(200, {
      ...
      // Every deploy must serve one matching HTML/CSS/JS version. The service worker
      // still provides the explicit offline cache, so the browser cache may revalidate.
